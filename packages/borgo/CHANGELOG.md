...
* borgo now requires go >= 1.27. `bunx borgo doctor` names the version and the install link on an older machine.
...
* @/ imports are the default, guarded exactly like the climb they replace ([c8015d9](https://github.com/LuigiDavideMicca/borgo/commit/c8015d96902d250f0629018155abbe6b0d48c4bd))
* **env:** the app's environment, declared once and refused at boot ([7c2df2d](https://github.com/LuigiDavideMicca/borgo/commit/7c2df2d61588bf62d504a743aa5f46acfc418522))
* **export:** a revalidate page is skipped by name - it asked for a server ([21fbed3](https://github.com/LuigiDavideMicca/borgo/commit/21fbed354ffa06f86d850aee03b6f12c7a0e7d4d))
* **isr:** copies survive a restart, and every replay re-mints its csp nonce ([309b83d](https://github.com/LuigiDavideMicca/borgo/commit/309b83db30103cf2d954fe0c737f60c83ef63d04))
* **isr:** the grammar, the guard and the bounded cache - the pure core first ([dfbb372](https://github.com/LuigiDavideMicca/borgo/commit/dfbb37253c79fcc2e4b03c0bffe28c3b0f9a18bb))
* **isr:** the orchestrator, the wiring, and borgo.Revalidate on the channel that already exists ([fe05e9b](https://github.com/LuigiDavideMicca/borgo/commit/fe05e9b10965061280736f32fa038dd8797e545b))
* the dev refresh transform is bun's own, and babel leaves the tree ([c374575](https://github.com/LuigiDavideMicca/borgo/commit/c3745752abb67427b3413444f7cff0612aff98c0))
...
* **doctor:** a second bun in ~/.bun is checked, because bin shims run it ([0115bcd](https://github.com/LuigiDavideMicca/borgo/commit/0115bcda4894ea8a1a84c12d40e5d3769d47d4c7))
* **env:** the default keeps the contract it was skipping ([dd23877](https://github.com/LuigiDavideMicca/borgo/commit/dd23877fe55b4502c91a73605d5f2477c8b20403))
* **env:** the schema travels on a file, debugging travels on stdout ([8c0e3c8](https://github.com/LuigiDavideMicca/borgo/commit/8c0e3c8b6ccb5bd40804294132496031b4f2ec0c))
* **isr:** a refused page renders for its visitor, once-per-window, and a ([ca0838f](https://github.com/LuigiDavideMicca/borgo/commit/ca0838f0e55f8643c261f4e51d197fcda25be022))
* **isr:** an invalidation dooms the render in flight instead of losing to it ([4eeb4ba](https://github.com/LuigiDavideMicca/borgo/commit/4eeb4ba6a032603f382bc3ae5498da7ef5f3112e))
* **isr:** the invalidation matches what it says - the starred base, both spellings ([fad143f](https://github.com/LuigiDavideMicca/borgo/commit/fad143f46c23ec0410d2227fb312cbef3f84fafe))
* **refresh:** export default memo() is registered, not remounted ([0432a44](https://github.com/LuigiDavideMicca/borgo/commit/0432a44d7b0330e78ebd3ded50060c79526dc982))
* **refresh:** only react's own memo and forwardRef register, aliases included ([9ea5eac](https://github.com/LuigiDavideMicca/borgo/commit/9ea5eac390b57626d71bf8b7cbf13badbe136df4))
* **refresh:** the post-bundle passes stop reading strings as code ([50a4a86](https://github.com/LuigiDavideMicca/borgo/commit/50a4a863d751993ee5b42a7758c384ff6a4ce2f7))
* **start:** an empty NODE_ENV must not re-exec forever ([e80d38e](https://github.com/LuigiDavideMicca/borgo/commit/e80d38e2e276a1de65acf5ef7e128182b92863a7))
* **start:** the NODE_ENV default rides the launch environment - module code is too late ([078c0ef](https://github.com/LuigiDavideMicca/borgo/commit/078c0efcaaf027f1d49a1c46b839a1195c8ea348))
...
* the go floor moves to 1.27, the toolchain the release is verified against ([61a22ec](https://github.com/LuigiDavideMicca/borgo/commit/61a22eca1965da0918f3f02717781aa38745f39a))
* the second hunt's first wave - the env wall, the blind mask, one spelling per path ([cf3e1f6](https://github.com/LuigiDavideMicca/borgo/commit/cf3e1f608df7c08674adc7e3d74b85342fca51a2))
* the second hunt's last wave - every finding closed, none parked ([dca9d19](https://github.com/LuigiDavideMicca/borgo/commit/dca9d198744eea6c79b3fecc38245baae38b5e92))


### Performance Improvements

* **routing:** a route outranks an extension-less file, and pages stop paying its stat ([2ea2bc0](https://github.com/LuigiDavideMicca/borgo/commit/2ea2bc05b93212e0e2658816ea6af1955fcd067e))
* **ssr:** documents share a pool of gzip streams, +7% at c=50 and +20% at c=10 ([453811a](https://github.com/LuigiDavideMicca/borgo/commit/453811aaa08bf5d3d2daa2e10695181fd7099b71))
* **ssr:** production loads production react, +36% on the bench ssr page ([913f050](https://github.com/LuigiDavideMicca/borgo/commit/913f0508ab516c83cf0d4f8bcf1f618183c49b1c))
* **static:** the indexed path stats without holding the event loop, +14% ([9666fd5](https://github.com/LuigiDavideMicca/borgo/commit/9666fd51ba8977e042ced4a3539079342e7ff8b6))
