...
* **create-borgo:** every scaffold except minimal ships a typed env.ts ([546a687](https://github.com/LuigiDavideMicca/borgo/commit/546a687b2ba60b5f0991fad8f4c9a19b87055555))
* **create-borgo:** full template tells the whole isr story, base the easy half ([fbf567e](https://github.com/LuigiDavideMicca/borgo/commit/fbf567ed9b899fb6b34444378329b22c2085956c))
...
* **create-borgo:** the runtime image was missing tsconfig.json and env.ts ([6001424](https://github.com/LuigiDavideMicca/borgo/commit/6001424809eae6735f28f942d7904a9092751ddc))
* the dockerfiles ship the floors the release declares ([6108f4c](https://github.com/LuigiDavideMicca/borgo/commit/6108f4cf990d3bf586f093ef4a06fc919eeb531c))
